...
import './office-home.css';

const OHome = () => {
	return (
		<div className='OHome'>
			<section className='head'>
				<link rel='stylesheet' href='office-home.css' />
			</section>
					...
					<div
						...
						<ul className='list-group d-flex flex-column justify-content-evenly'>
							...
							<li className='list-group-item d-flex justify-content-between'>
								...
								<span>ali_sozen@foo.com</span>
							</li>
							<li className='list-group-item d-flex justify-content-between'>
								<span className='list-attr'>Register No</span>
								<span>11114547412</span>
							</li>
							<li className='list-group-item d-flex justify-content-between'>
						...
						<div
							...
							<ul className='col-12 list-group d-flex flex-column justify-content-evenly'>
								<li class='list-group-item d-flex justify-content-between pb-2'>
									<span class='list-attr'>Waiting for Graphics Designer</span>
									<span>0</span>
								</li>
								<li class='list-group-item d-flex justify-content-between pb-2'>
									<span class='list-attr'>Waiting for Production</span>
									<span>8</span>
								</li>
